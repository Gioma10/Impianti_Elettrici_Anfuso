        ...
        <section id='aboutMe' className='about-me'>
            ...
            <div className='w-full h-full flex justify-center items-start'>
                ...
                <p className='smallest-p w-5/6 text-xs sm:text-sm md:text-base md:w-2/3 xl:w-1/2 p-10 bg-cyan-700 rounded-3xl relative'>
                    Ciao! Sono Antonino Anfuso, elettricista professionista con oltre 22 anni di esperienza. La mia passione per l’elettricità è nata fin da giovane, e oggi mi dedico a realizzare impianti sicuri ed efficienti sia in ambito civile che industriale.
                    Nel mio lavoro metto al primo posto le esigenze dei clienti, garantendo sempre la massima qualità e conformità alle normative. Sono aggiornato sulle ultime tecnologie, per offrirti soluzioni innovative e sostenibili.
                    Se cerchi un elettricista affidabile e competente, sono qui per aiutarti con qualsiasi progetto, grande o piccolo. Contattami per un servizio professionale su misura per le tue necessità.
